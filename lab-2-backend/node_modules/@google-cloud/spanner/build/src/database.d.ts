...
import { Snapshot, TimestampBounds, Transaction, ExecuteSqlRequest, RunUpdateCallback } from './transaction';
...
declare type UpdateSchemaCallback = ResourceCallback<GaxOperation, databaseAdmin.longrunning.IOperation>;
declare type UpdateSchemaResponse = [GaxOperation, databaseAdmin.longrunning.IOperation];
...
declare class Database extends ServiceObject {
    ...
    constructor(instance: Instance, name: string, poolOptions?: SessionPoolConstructor | SessionPoolOptions);
    /**
    ...
    run(query: string | ExecuteSqlRequest, options?: TimestampBounds): Promise<Row[]>;
